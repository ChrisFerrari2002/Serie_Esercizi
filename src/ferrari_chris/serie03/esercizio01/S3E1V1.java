...
public class S3E1V1 {
	...
	private static class CategorizeByAgeDecades implements CategorizeOperation<Integer> {
	...
	private static class CategorizeByOccupation implements CategorizeOperation<String> {
	...
	private static class CategorizeBySurname implements CategorizeOperation<String> {
	...
	private static class EvaluateHighschoolStudent implements EvaluateOperation {
